"""
BigQuery Connection Test with Direct Certificate Reference

This script tests the connection to BigQuery by directly referencing the Netskope certificate.
It sets all environment variables to point directly to the Netskope certificate.
"""
...
def test_bigquery_connection():
    ...
    print_header("BigQuery Connection Test with Direct Certificate Reference")
