...
This script uses the parser.py module to fetch Jira issue data and save
...
import sys
import argparse
from parser import connect_to_jira_api, extract_jira_data


def save_jira_issue(
    issue_key, raw_response_dir="jira_raw_responses", bypass_ssl_verify=None
):
    """
